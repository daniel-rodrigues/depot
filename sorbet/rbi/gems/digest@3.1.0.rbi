...
class Digest::SHA2 < ::Digest::Class
  ...
  #
  # source://digest//digest/sha2.rb#61
  ...
  #
  # source://digest//digest/sha2.rb#89
  def <<(str); end
  ...
  #   # => 1024
  #
  # source://digest//digest/sha2.rb#112
  ...
  # (256 bits) in size.
  #
  # source://digest//digest/sha2.rb#130
  def digest_length; end

  # source://digest//digest/sha2.rb#138
  def inspect; end
  ...
  #
  # source://digest//digest/sha2.rb#79
  def reset; end
  ...
  # source://digest//digest/sha2.rb#95
  def finish; end

  # source://digest//digest/sha2.rb#134
